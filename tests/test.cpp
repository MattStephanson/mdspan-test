...
TEST(extent_tests, extent) {
    static_assert(extents<2, 3>{}.extent(0) == 2);
    static_assert(extents<2, 3>{}.extent(1) == 3);

    static_assert(extents<2, dynamic_extent>{3}.extent(0) == 2);
    static_assert(extents<2, dynamic_extent>{3}.extent(1) == 3);

    static_assert(extents<dynamic_extent, dynamic_extent>{2, 3}.extent(0) == 2);
    static_assert(extents<dynamic_extent, dynamic_extent>{2, 3}.extent(1) == 3);

    constexpr extents<2, dynamic_extent, dynamic_extent> e_2dd{ 3,5 };
...
TEST(extent_tests, equality) {
    ...
    extents<2, 3> e_23;
    extents<2, dynamic_extent> e_2d{ 3 };
    extents<dynamic_extent, 3> e_d3{ 2 };
    extents<dynamic_extent, dynamic_extent> e_dd{ 2,3 };
...
TEST(layout_left_tests, copy_ctor) {
    copy_ctor_helper_left(extents<2, 3>{});
    copy_ctor_helper_left(extents<5, dynamic_extent>{7});
    copy_ctor_helper_left(extents<dynamic_extent, 13>{11});
    copy_ctor_helper_left(extents<dynamic_extent, dynamic_extent>{17, 19});
}
...
TEST(layout_left_tests, assign) {
    assign_helper_left(extents<2, 3>{});
    assign_helper_left(extents<5, dynamic_extent>{7});
    assign_helper_left(extents<dynamic_extent, 13>{11});
    assign_helper_left(extents<dynamic_extent, dynamic_extent>{17, 19});
}
...
TEST(layout_right_tests, copy_ctor) {
    copy_ctor_helper_right(extents<2, 3>{});
    copy_ctor_helper_right(extents<5, dynamic_extent>{7});
    copy_ctor_helper_right(extents<dynamic_extent, 13>{11});
    copy_ctor_helper_right(extents<dynamic_extent, dynamic_extent>{17, 19});
}
...
TEST(layout_right_tests, assign) {
    assign_helper_right(extents<2, 3>{});
    assign_helper_right(extents<5, dynamic_extent>{7});
    assign_helper_right(extents<dynamic_extent, 13>{11});
    assign_helper_right(extents<dynamic_extent, dynamic_extent>{17, 19});
}
...
TEST(layout_stride_tests, copy_ctor) {
    copy_ctor_helper_stride(extents<2, 3>{});
    copy_ctor_helper_stride(extents<5, dynamic_extent>{7});
    copy_ctor_helper_stride(extents<dynamic_extent, 13>{11});
    copy_ctor_helper_stride(extents<dynamic_extent, dynamic_extent>{17, 19});
}
...
TEST(layout_stride_tests, assign) {
    assign_helper_stride(extents<2, 3>{});
    assign_helper_stride(extents<5, dynamic_extent>{7});
    assign_helper_stride(extents<dynamic_extent, 13>{11});
    assign_helper_stride(extents<dynamic_extent, dynamic_extent>{17, 19});
}
...
TEST(mdspan_tests, assign)
{
    ...
    EXPECT_EQ(mds2.extents(), extents<2>{});
